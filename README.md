...
## i'm part of
- `@SwiftTec`: collaborating in the development of a mobile application as part of the `research & development` team, as an ios dev.
...
- `@Genobit`: collaborating as a coordinator in the It team, responsible of the development of technology projects related to web development and services with my teammates.
